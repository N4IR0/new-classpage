<?php
	if (isset($_GET["id1"]) && !empty($_GET["id1"])) {
		...
		echo "<h3>Vertretungen <a style='float: right;' href=".$CONFIG["website"]["admin_path"]."timetable/group2/create/substitution>(Erstellen)</a></h3>";
			...
			echo "<tbody>";
				while ($row = mysql_fetch_assoc($result)) {
					echo "<tr>";
						...
						echo "<td><a href=".$CONFIG["website"]["admin_path"]."timetable/group2/edit/".$row["id"].">x</a></td>";
						echo "<td><a href=".$CONFIG["website"]["admin_path"]."timetable/group2/delete/".$row["id"].">x</a></td>";
					echo "</tr>";
				}
			echo "</tbody>";
		echo "</table>";
		...
		echo "<h3>Ausfall <a style='float: right;' href=".$CONFIG["website"]["admin_path"]."timetable/group2/create/cancellation>(Erstellen)</a></h3>";
