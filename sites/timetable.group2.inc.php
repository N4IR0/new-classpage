<?php
	...
	echo buildTimetable(2, $timestamp);
	echo "<p style='text-align: center;'><a href='/timetable/group2/show/$prev'>&laquo Vorherige Woche</a> | <a href='/timetable/group2'>Aktuelle Woche</a> | <a href='/timetable/group2/show/$next'>Nächste Woche &raquo</a></p><br>";
?>